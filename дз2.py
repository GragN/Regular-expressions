...
new_list3 = list()
new_list4 = list()
for id, lists in enumerate(new_list2):
    if lists[0] not in new_list3:
        new_list3.append(lists[0])
    else:
        new_list4.append(lists[0])
...
for lists in new_list2:
    if lists[0] not in new_list5:
        new_list6.append(lists)
    else:
        new_list7.append(lists)

for id, lists in enumerate(new_list6):
    pass
